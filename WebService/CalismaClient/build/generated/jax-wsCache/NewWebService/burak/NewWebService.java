 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://burak/", wsdlLocation = "http://localhost:8080/Calisma/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://burak/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Calisma/NewWebService?wsdl");
     ...
     *     returns CalismaWS
     */
    @WebEndpoint(name = "CalismaWSPort")
    public CalismaWS getCalismaWSPort() {
        return super.getPort(new QName("http://burak/", "CalismaWSPort"), CalismaWS.class);
    }
     ...
     */
    @WebEndpoint(name = "CalismaWSPort")
    public CalismaWS getCalismaWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://burak/", "CalismaWSPort"), CalismaWS.class, features);
    }
